...
bc(javascript). var curly = new Element('div', {
  id : 'curly',
  'class' : 'stooge'
});
...
bc(javascript). var $curly = $('<div id="curly" class="stooge" />');
...
bc(javascript). var curly = $E('div#curly.stooge');
...
bc(javascript). function $E(tag, props) {
...
bc(javascript). var moe = $E('#moe.stooge.leader', {...});
...
bc(javascript). $E = document.getElement.bind(document);
